<?php
   ...
   else
   {
      ...
      header("refresh:3;	url=../view/admin_Profile.php");
   }
?>
...
<head>
  <title>ADMIN PROFILE</title>
   ...
   <body><center>
        <fieldset>
           <legend align="center"><h1>Profile of ADMIN</h1></legend>
              <table border="2">
               <tr>
                 <td colspan="3"><a href="admin_Dashboard.php">Admin Home</a></td>
               </tr>
                <tr>
                    <th>Full Name</th>
                    <th>Username</th>
                ...
                <tr>
                    ...
                    <td> <a href="admin_Profile.php?fullname=<?= $user['fullname'] ?>">Edit</a> </td>
                </tr>
